...
if __name__ == '__main__':
    ...
    """
    # main("nq", model, tokenizer, instruct, "-directly-list-answer-passages-", 1)  # NQ skipped
    ...
    """
    # main("nq", model, tokenizer, instruct, "-directly-point-answer-passage-", 0)  # NQ skipped
    ...
    """
    # main("nq", model, tokenizer, instruct, "-directly-list-answer-cot-passages3-", 1)  # NQ skipped
    ...
    """
    # main("nq", model, tokenizer, instruct, "-directly-point-answer-cot-passage3-", 0)  # NQ skipped 
    ...
    """
    # main("nq", model, tokenizer, instruct, "-directly-list-", 1)  # NQ skipped
    ...
    """
    # main("nq", model, tokenizer, instruct, "-directly-point-", 0)  # NQ skipped 
